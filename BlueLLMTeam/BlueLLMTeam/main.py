...
if __name__ == "__main__":
    ...
    prompt_dict = {
        ...
        "message": "can you create the code in linux to create a folder structure for a bakery. Guess what that should look like. Task: provide a json of the code with the files. JSON: [{'Content_Type':'code  for creating File,folder,package etc...','Contents':' code if file then it should be file contents, if folder should be folder name'},{'Content_Type':'File,folder,package etc...','Contents':'if file then it should be file contents, if folder should be folder name'}]",
        "model" : "gpt-3.5-turbo"
    }
